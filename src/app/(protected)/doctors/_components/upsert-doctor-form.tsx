...
const formSchema = z
  .object({
    ...
    availableFromWeekDay: z
      .string()
      .trim()
      .min(1, { message: "Disponível de é obrigatório" }),
    availableToWeekDay: z
      .string()
      .trim()
      .min(1, { message: "Disponível até é obrigatório" }),
    availableFromTime: z
      .string()
      .trim()
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Preço de consulta</FormLabel>
                <FormControl>
                  <NumericFormat
                    value={field.value}
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      médico e todas as consultas agendadas com ele.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
